...
int main (int argc, const char * argv[]) {
    GVariant *my_variant_array = NULL;
    GVariantBuilder *my_variant_builder = NULL;

    {
        // set
        my_variant_builder = g_variant_builder_new(G_VARIANT_TYPE("a(ss)"));
        ...
        my_variant_array = g_variant_new("a(ss)", my_variant_builder);
    }
